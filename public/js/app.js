...
if (document.getElementById('owl-1') || document.getElementById('owl-2')) {
  ...
  __webpack_require__(/*! ./scripts/slider */ "./resources/js/scripts/slider.js");
}

if (document.getElementById('testimonios')) {
  __webpack_require__(/*! ./scripts/pagination */ "./resources/js/scripts/pagination.js");

  __webpack_require__(/*! ../youtube-video/js/grt-youtube-popup */ "./resources/youtube-video/js/grt-youtube-popup.js");

  __webpack_require__(/*! ./scripts/paginationImplementar */ "./resources/js/scripts/paginationImplementar.js");
}
...
/***/ "./resources/js/scripts/pagination.js":
/*!********************************************!*\
  !*** ./resources/js/scripts/pagination.js ***!
  \********************************************/
/*! no static exports found */
...
/***/ "./resources/js/scripts/paginationImplementar.js":
/*!*******************************************************!*\
  !*** ./resources/js/scripts/paginationImplementar.js ***!
  \*******************************************************/
/*! no static exports found */
    ...
    var options = {
      ...
      callback: function callback(response, pagination) {
        ...
        $.each(response, function (index, item) {
          console.log(item);
          dataHtml += '<li><div class="text-center"> <div> <p class="title primary-color">' + item.titulo + '	</p> </div><img src=" https://img.youtube.com/vi/' + item.link_youtube + '/sddefault.jpg " alt="" width="280px"><br><a youtubeid="' + item.link_youtube + '" class="btn"><i class="fab fa-youtube"></i> VER</a></div></li>';
        });
        dataHtml += '';
...
/***/ "./resources/youtube-video/js/grt-youtube-popup.js":
/*!*********************************************************!*\
  !*** ./resources/youtube-video/js/grt-youtube-popup.js ***!
  \*********************************************************/
/*! no static exports found */
...
(function ($) {
  $.fn.grtyoutube = function (options) {
    return this.each(function () {
      // Get video ID
      var getvideoid = $(this).attr("youtubeid"); // Default options

      var settings = $.extend({
        videoID: getvideoid,
        autoPlay: true,
        theme: "dark"
      }, options); // Convert some values
...
__webpack_require__(/*! C:\xampp\htdocs\github\terranova\resources\js\app.js */"./resources/js/app.js");
__webpack_require__(/*! C:\xampp\htdocs\github\terranova\resources\sass\app.scss */"./resources/sass/app.scss");
module.exports = __webpack_require__(/*! C:\xampp\htdocs\github\terranova\resources\sass\admin\app_admin.scss */"./resources/sass/admin/app_admin.scss");
