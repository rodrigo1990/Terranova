								...
								@foreach($proyecto->lineaColectivo as $lineaColectivo)
									...
									<li id="lc-li-{{$counterLc}}">
										...
										<div style="height: 50px;">
											...
											<input type="text" name="lineasColectivos[]" class="lineasColectivos form-control" placeholder="501 Astolfi - Pilar" value="{{$lineaColectivo->descripcion}}" style="float:left;width: 98% !important;">
											
											<a  style="float:left;width: 1%;height: 100%;">
										...
										<input type="hidden" name="id" value="{{$lineaColectivo->id}}">
